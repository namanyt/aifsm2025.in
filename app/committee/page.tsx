...
import { COMMITTEE_PDF, COMMITTEES_DATA } from "@/lib/types";
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gradient-to-r shadow-md to-[#1C4024] from-[#1C403C] backdrop-blur-sm rounded-xl p-8 mb-8">
            {/* Chairperson Card */}
            {chairperson && (
              <div className="mb-8">
                <div className="bg-[#1C4024]/60 border-2 border-[#468E62] rounded-xl p-6 max-w-sm mx-auto text-center shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 place-items-center">
                {otherMembers.map((member, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`bg-white/10 border border-teal-500/30 rounded-lg p-5 text-center shadow-md hover:bg-[#EAF6F4]/30 transition-all duration-300 w-full max-w-sm ${
          ...
          <div className="flex justify-center mb-6">
            <Button
              className="text-black border-2 border-red-500 bg-white cursor-pointer px-6 py-2.5 rounded-lg font-medium hover:bg-red-200 transition-colors duration-300 flex items-center gap-2 shadow-md"
              onClick={() => window.open(COMMITTEE_PDF, "_blank")}
            >
